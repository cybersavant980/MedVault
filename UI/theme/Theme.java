...
public final class Theme {
    private Theme() {}
    public static final int WINDOW_WIDTH = 1400,WINDOW_HEIGHT = 850;
    //colours
    ...
    public static final Font SIDEBAR_FONT = new Font("Segoe UI", Font.BOLD, 15);
    public static final Font CARD_TITLE = new Font("Segoe UI", Font.BOLD, 16);
    public static final Font CARD_VALUE = new Font("Segoe UI", Font.BOLD, 34);
    //buttons
    ...
    //borders
    public static final Border EMPTY_BORDER = BorderFactory.createEmptyBorder(12,16,12,16);
    public static final Border PANEL_BORDER = BorderFactory.createLineBorder(BORDER);
}