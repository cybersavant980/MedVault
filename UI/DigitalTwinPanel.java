...
public class DigitalTwinPanel extends JPanel {
    private JLabel titleLabel,subtitleLabel,humanBodyImage;
    private JComboBox<String> bodyPartCombo;
    private JTextArea organDescriptionArea,patientObservationArea;
    ...
    private void initializeComponents() {
        ...
        subtitleLabel = new JLabel("Interactive Human Body & Disease Viewer");
        ...
        humanBodyImage.setBorder(BorderFactory.createLineBorder(Theme.BORDER));
        bodyPartCombo = new JComboBox<>(new String[]{"Select Body Part","Head","Eyes","Heart","Lungs","Liver","Kidney","Stomach","Hands","Legs"});
    ...
    private void layoutComponents() {
        ...
        JSplitPane splitPane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT,createBodyPanel(), createInformationPanel());
    ...
    private JPanel createInformationPanel() {
        ...
        JScrollPane descriptionScroll = new JScrollPane(organDescriptionArea);
        ...
        JLabel observationLabel = new JLabel("Patient Observation");
        observationLabel.setFont(Theme.SUBTITLE_FONT);
        JScrollPane observationScroll = new JScrollPane(patientObservationArea);
    ...
    private void registerEvents() {
        ...
        updateButton.addActionListener(e -> JOptionPane.showMessageDialog(this,"Patient observations updated successfully.","Information",JOptionPane.INFORMATION_MESSAGE));
    }

    private void updateOrganInformation() {
        String selectedPart = (String) bodyPartCombo.getSelectedItem();
        if (selectedPart == null) return;
        switch (selectedPart) {
            case "Head":
                organDescriptionArea.setText("Brain and nervous system.\n\n" + "Responsible for thinking, memory, " + "decision making and body coordination.");
                break;
            case "Eyes":
                organDescriptionArea.setText("Human vision organs.\n\n" + "Used for visual perception and balance.");
                break;
            case "Heart":
                organDescriptionArea.setText("Heart pumps blood throughout the body.\n\n" + "Common diseases:\n" + "• Hypertension\n" + "• Heart Attack\n" + "• Coronary Artery Disease");
                break;
            case "Lungs":
                organDescriptionArea.setText("Responsible for oxygen exchange.\n\n" + "Common diseases:\n" + "• Asthma\n" + "• Pneumonia\n" + "• COPD");
                break;
            case "Liver":
                organDescriptionArea.setText("Largest internal organ.\n\n" + "Functions:\n" + "• Detoxification\n" + "• Digestion\n" + "• Metabolism");
                break;
            case "Kidney":
                organDescriptionArea.setText("Filters blood and removes waste.\n\n" + "Common diseases:\n" + "• Kidney Stones\n" + "• Kidney Failure");
                break;
            case "Stomach":
                organDescriptionArea.setText("Primary digestive organ.\n\n" + "Common diseases:\n" + "• Gastritis\n" + "• Ulcers");
                break;
            case "Hands":
                organDescriptionArea.setText("Upper limb movement and coordination.");
                break;
            case "Legs":
                organDescriptionArea.setText("Responsible for walking and balance.");
                break;
            default:
                organDescriptionArea.setText("Select a body part to view its information.");
        }
    }
}