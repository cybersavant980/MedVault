...
public class MainFrame extends JFrame {
    ...
    private JButton passportBtn;
    private JButton reportBtn;
    private JButton twinBtn;
    ...
    private JPanel createSidebar() {
        ...
        patientBtn =
                createNavButton("👤 Patients");

        medicineBtn =
                createNavButton("💊 Medicines");

        emergencyBtn =
                createNavButton("🚨 Emergency");

        passportBtn =
                createNavButton("🪪 Passport");

        reportBtn =
                createNavButton("📊 Reports");

        twinBtn =
                createNavButton("🧬 Digital Twin");
