...
public class Dashboard extends JPanel {
    ...
    private DashboardCard patientCard,medicineCard,reminderCard,emergencyCard;
    private PatientManager patientManager;
    private MedicineManager medicineManager;
    private ReminderScheduler reminderScheduler;
    private EmergencyManager emergencyManager;
    private RoundedButton addPatientButton,addMedicineButton,emergencyButton,refreshButton;
    ...
    private void initializeComponents() {
        ...
        addPatientButton = new RoundedButton("Add Patient");
        addMedicineButton = new RoundedButton("Add Medicine");
        emergencyButton = new RoundedButton("Emergency");
    ...
    private JPanel createHeaderPanel() {
        ...
        JLabel subtitle = new JLabel("Offline Home Medical Record & Emergency Management System");
    ...
    private JPanel createQuickActionPanel() {
        ...
        addPatientButton.addActionListener(e -> parentFrame.openPanel("Patients"));
        addMedicineButton.addActionListener(e -> parentFrame.openPanel("Medicines"));
        emergencyButton.addActionListener(e -> parentFrame.openPanel("Emergency"));
        refreshButton.addActionListener(e -> refreshDashboard());
        return panel;
    }

    public void setPatientCount(int count) {patientCard.setValue(String.valueOf(count));}

    public void setMedicineCount(int count) {medicineCard.setValue(String.valueOf(count));}

    public void setReminderCount(int count) {reminderCard.setValue(String.valueOf(count));}

    public void setEmergencyCount(int count) {emergencyCard.setValue(String.valueOf(count));}
    ...
    public void refreshDashboard() {
        ...
        setPatientCount(patientManager.getPatientCount());
        setMedicineCount(medicineManager.getMedicineCount());
        setReminderCount(reminderScheduler.getReminderCount());
        setEmergencyCount(emergencyManager.getEmergencyCount());
    }
}