...
public class LoginFrame extends JFrame {
    ...
    private RoundedButton loginButton,clearButton,exitButton;
    public LoginFrame() {
    ...
    private void registerEvents() {
        ...
        clearButton.addActionListener(e -> { usernameField.setText(""); passwordField.setText(""); usernameField.requestFocus(); });
    ...
    private void validateLogin() {
        ...
        if (username.isEmpty()) {
            MessageDialog.showError(this,"Please enter username.");
            usernameField.requestFocus();
            return;
        }
        if (password.isEmpty()) {
            MessageDialog.showError(this,"Please enter password.");
            passwordField.requestFocus();
            return;
        }
        if (username.equals("admin") && password.equals("admin123")) {
            MessageDialog.showSuccess(this,"Welcome to MedVault!");
            dispose();
